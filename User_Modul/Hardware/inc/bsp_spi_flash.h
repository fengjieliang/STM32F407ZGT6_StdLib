...
#define FLASH_SPI_CS_LOW()								GPIO_ResetBits(SPI1_CS_GPIO_Port,SPI1_CS_Pin)
#define FLASH_SPI_CS_HIGH()								GPIO_SetBits(SPI1_CS_GPIO_Port,SPI1_CS_Pin)

#define W25X128_Enable()  	FLASH_SPI_CS_LOW()
#define W25X128_Disable()  FLASH_SPI_CS_HIGH()
